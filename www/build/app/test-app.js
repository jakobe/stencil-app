...
var TestApp = (function () {
    ...
    TestApp.prototype.render = function () {
        return (h("stencil-router", { "title-suffix": " - Stencil Router Demos" }, h("ul", null, h("li", null, h("stencil-route-link", { "url": "/", "exact": true }, "Exact Base Link")), h("li", null, h("stencil-route-link", { "url": "/" }, "Base Link")), h("li", null, h("stencil-route-link", { "url": "/demo", "urlMatch": ["/demo", "/demox"], "exact": true }, "Demo Link")), h("li", null, h("stencil-route-link", { "url": "/demo2" }, "Demo2 Link")), h("li", null, h("stencil-route-link", { "url": "/demo3" }, "Demo3 Link")), h("li", null, h("stencil-route-link", { "url": "/demo3/page1" }, "Demo3 Page1 Link")), h("li", null, h("stencil-route-link", { "url": "/demo3/page2" }, "Demo3 Page2 Link")), h("li", null, h("stencil-route-link", { "url": "/demo4" }, "Demo4 Link")), h("li", null, h("stencil-route-link", { "url": "/demo6/" }, "Demo6 Link"))), h("stencil-route", { "url": "/", "exact": true, "routeRender": function (props) {
            ...
            } }), h("stencil-route", { "url": "/demo3", "component": "test-demo-three", "componentProps": { "pages": ["intro/index.html"] } }), h("stencil-route", { "url": "/demo4", "component": "test-demo-four" }), h("stencil-route", { "url": "/demo5", "component": "async-content", "componentProps": { "location": "/" } }), h("stencil-route", { "url": "/demo6", "component": "test-demo-six" })));
    };
    return TestApp;
}());

var TestDemoFour = (function () {
    ...
    TestDemoFour.prototype.render = function () {
        ...
        return (h("div", null, h("a", { "onclick": function (e) { return _this.handleClick(e, linkLocation); }, "href": linkLocation }, "History push to ", linkLocation), h("pre", null, h("b", null, "this.pages"), ":", h("br", null), JSON.stringify(this.pages, null, 2)), h("pre", null, h("b", null, "this.match"), ":", h("br", null), JSON.stringify(this.match, null, 2)), h("pre", null, h("b", null, "this.history.location"), ":", h("br", null), JSON.stringify(this.history.location, null, 2))));
    };
    return TestDemoFour;
}());

var TestDemoSix = (function () {
    ...
    TestDemoSix.prototype.render = function () {
        ...
        return [
            ...
            h("stencil-route", { "url": "/demo6/", "group": "main", "exact": true, "routeRender": function (props) {
                    return [
                        h("h1", null, "One"),
        ...
        return [
            ...
            h("stencil-route", { "url": "/demo3/page1", "exact": true, "routeRender": function (props) {
                    ...
                    return [
                        ...
                        h("pre", null, h("b", null, "props.pages"), ":", h("br", null), JSON.stringify(_this.pages, null, 2)),
                        h("pre", null, h("b", null, "props.match"), ":", h("br", null), JSON.stringify(_this.match, null, 2)),
                        h("pre", null, h("b", null, "props.history.location"), ":", h("br", null), JSON.stringify(_this.history.location, null, 2))
                    ];
                } }),
